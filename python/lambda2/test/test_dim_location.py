...
class TestDimLocation:
    ...
    def test_function_makes_dim_location_table(self, address_df):
        output = dim_location(address_df)
        assert list(output.columns) == ["location_id",
                                        "address_line_1",
                                        "address_line_2",
                                        "district",
                                        "city",
                                        ...
                                        "country",
                                        "phone"]
        assert list(output.iloc[0]) == [1, "6826 Herzog Via",
                                        "", "Avon",
                                        "New Patienceburgh",
                                        "28441", "Turkey",
                                        "1803 637401"]
        assert list(output.iloc[1]) == [2, "179 Alexie Cliffs", "",
                                        "", "Aliso Viejo", "99305-7380",
                                        "San Marino", "9621 880720"]
        assert list(output.iloc[2]) == [3, "148 Sincere Fort", "", "",
                                        "Lake Charles", "89360",
                                        "Samoa", "0730 783349"]
