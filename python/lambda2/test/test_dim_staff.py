...
class TestStaff:
    def test_dataframe_for_staff_deparment_merged_dataframe(self):
        ...
        dept_columns = ["department_id", "department_name", "location", "manager", "created_at", "last_updated"]
        dept_data = [
    ...
    def test_to_check_empty_inputs(self):
        ...
        dept_df = pd.DataFrame(columns=["department_id", "department_name", "location", "manager"])
