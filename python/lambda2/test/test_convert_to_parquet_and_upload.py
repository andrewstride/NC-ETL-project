from src.convert_to_parquet_and_upload import (convert_to_parquet,
                                               upload_to_processing_bucket)
from testconf import (processing_bucket,
                      test_parquet)
import pandas as pd
...
class TestUploadToProcessingBucket:
    ...
    def test_uploads_parquet_to_processing_bucket(self,
                                                  mock_datetime,
                                                  processing_bucket,
                                                  test_parquet):
        mock_datetime.now.return_value = "timestamp"
        table_name = "dim_design"
        output = upload_to_processing_bucket(processing_bucket,
                                             test_parquet,
                                             table_name)
        ...
        response = processing_bucket.list_objects_v2(
    ...
    def test_parquet_contains_correct_data(self,
        ...
        mock_datetime.now.return_value = "timestamp"
        table_name = "dim_design"
        upload_to_processing_bucket(processing_bucket,
                                    test_parquet,
                                    table_name)
    ...
    @patch("src.convert_to_parquet_and_upload.datetime")
    def test_handles_no_dataframe_error(self,
                                        mock_datetime,
                                        processing_bucket):
    ...
    @patch("src.convert_to_parquet_and_upload.datetime")
    def test_handles_no_bucket_error(self,
                                     mock_datetime,
                                     test_parquet):
        with LogCapture() as log:
            mock_datetime.now.return_value = "timestamp"
    ...
    @patch("src.convert_to_parquet_and_upload.datetime")
    def test_handles_non_existant_table_name(self,
                                             mock_datetime,
                                             test_parquet,
                                             processing_bucket
                                             ):
