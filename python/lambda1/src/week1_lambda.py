...
from src.utils import get_all_rows, get_columns, write_to_s3, get_tables, fetch_last_timestamps_from_db, get_new_rows
...
def lambda_handler(event, context):
    try:
        ...
        write_to_s3(s3, 'nc-terraformers-ingestion', 'timestamp_table', 'json', timestamp_dict)
