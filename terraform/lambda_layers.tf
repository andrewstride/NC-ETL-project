...
resource "null_resource" "create_dependencies" {
    provisioner "local-exec" {
        command = "pip install -r ${path.module}/../requirements-${var.lambda1_name}.txt -t ${path.module}/../dependencies-${var.lambda1_name}/python"
    }
    triggers = {
...
data "archive_file" "layer_code_for_lambda1" {
    ...
    source_dir = "${path.module}/../dependencies-${var.lambda1_name}"
}
