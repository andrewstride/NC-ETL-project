...
resource "aws_lambda_function" "lambda1" {
    ...
    runtime = "python3.12"
    layers = [aws_lambda_layer_version.layer_for_lambda1.arn, "arn:aws:lambda:eu-west-2:336392948345:layer:AWSSDKPandas-Python312:13"]
...
resource "aws_lambda_function" "lambda2" {
    ...
    runtime = "python3.12"
    layers = [aws_lambda_layer_version.layer_for_lambda2.arn, "arn:aws:lambda:eu-west-2:336392948345:layer:AWSSDKPandas-Python312:13"]
